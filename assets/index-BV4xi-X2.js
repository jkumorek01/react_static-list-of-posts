...
aut aut aut maxime quia temporibus ut omnis`}],zc=[{userId:1,id:1,title:"sunt aut facere repellat provident occaecati excepturi optio reprehenderit",body:`quia et suscipit
...
expedita consequatur consequatur dolores quia eos et placeat`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>O.jsxs("div",{className:"CommentInfo",children:[O.jsxs("div",{className:"CommentInfo__title",children:[O.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",O.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),O.jsx("div",{className:"CommentInfo__body",children:e.body})]});function Lc({comments:e}){return O.jsx("div",{className:"CommentList",children:e.map(t=>O.jsx(Pc,{comment:t},t.id))})}const Tc=({user:e})=>O.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Mc=({post:e})=>O.jsxs("div",{className:"PostInfo",children:[O.jsxs("div",{className:"PostInfo__header",children:[O.jsx("h3",{className:"PostInfo__title",children:e.title}),O.jsxs("p",{children:[" Posted by ",e.user&&O.jsx(Tc,{user:e.user})]})]}),O.jsx("p",{className:"PostInfo__body",children:e.body}),O.jsx("hr",{}),e.comments.length?O.jsx(Lc,{comments:e.comments}):O.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}),Rc=[...zc].map(e=>{const t=[];for(const a of Cc)e.id===a.postId&&t.push(a);let i;for(const a of Nc)e.userId===a.id&&(i=a);return{...e,comments:t,user:i}}),Dc=({posts:e})=>O.jsx("div",{className:"PostList",children:e.map(t=>O.jsx(Mc,{post:t},t.id))}),jc=()=>O.jsxs("section",{className:"App",children:[O.jsx("h1",{className:"App__title",children:"Static list of posts"}),O.jsx(Dc,{posts:Rc})]});em(document.getElementById("root")).render(O.jsx(jc,{}));
