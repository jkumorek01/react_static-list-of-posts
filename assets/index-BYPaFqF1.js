...
expedita consequatur consequatur dolores quia eos et placeat`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>$.jsxs("div",{className:"CommentInfo",children:[$.jsxs("div",{className:"CommentInfo__title",children:[$.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",$.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),$.jsx("div",{className:"CommentInfo__body",children:e.body})]});function Lc({comments:e}){return $.jsx("div",{className:"CommentList",children:e.map(t=>$.jsx(Pc,{comment:t},t.id))})}const Tc=({post:e})=>$.jsxs("div",{className:"PostInfo",children:[$.jsxs("div",{className:"PostInfo__header",children:[$.jsx("h3",{className:"PostInfo__title",children:e.title}),$.jsxs("p",{children:[" Posted by ",e.user&&$.jsx("a",{className:"UserInfo",href:`mailto:${e.user.email}`,children:e.user.name})]})]}),$.jsx("p",{className:"PostInfo__body",children:e.body}),$.jsx("hr",{}),e.comments.length?$.jsx(Lc,{comments:e.comments}):"No comments yet"]}),Mc=[...zc].map(e=>{const t=[];for(const a of Cc)e.id===a.postId&&t.push(a);let i;for(const a of Nc)e.userId===a.id&&(i=a);return{...e,comments:t,user:i}}),Rc=()=>$.jsx("div",{className:"PostList",children:Mc.map(e=>$.jsx(Tc,{post:e},e.id))}),Dc=()=>$.jsxs("section",{className:"App",children:[$.jsx("h1",{className:"App__title",children:"Static list of posts"}),$.jsx(Rc,{})]});em(document.getElementById("root")).render($.jsx(Dc,{}));
